...
path = f"AC/output/{trial}-new_adaptive_{adaptiveTol}_1dis_GACGD_lrmax_{lr_max}_lrmin_{lr_min}_PINN_{layers[1]}_{layers[2]}_dis_{dis_layers[1]}_{dis_layers[2]}_warm_{warm_start}"
...
GACGD_optimizer = CGDS.GACGD(x_params = discriminator.parameters(), 
            ...
            lr_x=lr_max, lr_y=lr_min, tol=1e-7, atol = 1e-20, eps=1e-8, beta=0.99, track_cond = lambda x, y: True, warm_start = warm_start)
