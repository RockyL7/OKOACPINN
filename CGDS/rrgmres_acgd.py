...
from .rrgmres_torch import RRGMRES
...
class RRGACGD(object):
    def __init__(self, x_params, y_params,
                 x_reducer=None, y_reducer=None,
                 lr_x=1e-3, lr_y=1e-3,
                 eps=1e-6, beta=0.99,
                 tol=1e-5, atol=1e-6,
                 term_min = 0, rr_lambda = 0.1, init_prob = 0.0, warm_start = 1,
                 max_iter=None,
    ...
    def step(self, loss_x, loss_y, trigger=None):
        ...
        soln, uw_soln, (num_iter, err_history) = RRGMRES(Avp=Avp, b=RHS, x0=prev_x0,
                                              max_iter=self.max_iter,
                                              tol=tol, atol=atol, rr_lambda = self.rr_lambda, init_prob = self.init_prob,
